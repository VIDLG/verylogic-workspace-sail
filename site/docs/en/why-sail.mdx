...
The actual `hack.sail` model saves old state and then makes each write explicit:
...
The Sail project's RISC-V example first defines an instruction form and connects it to a 32-bit machine word:
