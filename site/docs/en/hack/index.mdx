...
| generated drivers, Sail's C backend, assertions, hooks, and tests | [Execution and tests](/hack/execution) |
...
3. Enter **Toolchain internals** and follow the same source through the [assembler](/hack/assembler).
4. Finish with the [execution and test workflow](/hack/execution).
